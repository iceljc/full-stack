...
{
    public class GenreMenu : IMenu
    {
        public int PrintMenu()
        {
            int choice = 0;

            string[] names = Enum.GetNames(typeof(GenreMenuOptions));
            int[] values = (int[])Enum.GetValues(typeof(GenreMenuOptions));

            int length = names.Length;

            Console.WriteLine("This is Genre System");
